<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarse.aspx.cs" Inherits="sakura.registrarse" %>
...
<form id="form1" runat="server">
  ...
  <p>
    <label for="email">Correo Electronico</label>
      ...
      <asp:TextBox ID="txtNonmbre" name="email" CssClass="email" runat="server" ToolTip="Escriba su Correo"></asp:TextBox>

  <p>
<label for="email">apellido paterno</label>
      <asp:TextBox ID="txtApellidoPaterno" name="email" CssClass="email" runat="server" ToolTip="Escriba su Correo"></asp:TextBox>

  </p>
      <p>
<label for="email">apellido Materno</label>
      <asp:TextBox ID="txtApellidoMaterno" name="email" CssClass="email" runat="server" ToolTip="Escriba Apellido Materno"></asp:TextBox>
